...
namespace VirtoCommerce.CatalogCsvImportModule.Data.Model
{
    public class CsvProductMappingConfiguration
    {
        ...
        public static CsvSetting GetDefaultCsvSetting(bool overWriteMultiValue = false)
        {
            return new CsvSetting { OverWriteMultiValue = overWriteMultiValue };
        }
        ...
        public static CsvProductMappingConfiguration GetDefaultConfiguration()
        {
            ...
            var optionalFields = ReflectionUtility.GetPropertyNames<CsvProduct>(x => x.Name, x => x.Id, x => x.Sku, x => x.CategoryPath, x => x.CategoryId, x => x.MainProductId, x => x.PrimaryImage, x => x.AltImage, x => x.SeoUrl, x => x.SeoTitle,
                                                                                ...
                                                                                x => x.PriceId, x => x.SalePrice, x => x.ListPrice, x => x.Currency, x => x.PriceListId, x => x.Quantity,
